...
| C4.4 ✅ | 切根:/platform/ = desktop 根,旧壳退役(app.js/旧测试/旧样式);doc 写动作/child_context/per-instance 题名/reparent 级联改址(docs/DESKTOP-WIDGET.md §12) | stub 32 全绿 + tests-ui 五套全绿(145 项)+ pytest 31 过 |
